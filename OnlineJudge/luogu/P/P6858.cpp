...
class Integer {
  public:
    ...
    Integer operator+(const Integer &other) const { return n + other.n; }
    Integer operator-(const Integer &other) const { return n - other.n; }
    Integer operator*(const Integer &other) const { return n * other.n; }
...
class Rational {
  public:
    ...
    operator Integer() const { return numerator / denominator; }
};
...
Rational f(const Integer &n, const Integer &m) {
    if (m.n == 0) {
        ...
        auto m2 = m * 2;
        auto nm_3 = nm + 3;
        return Rational(f_1.denominator * (n * nm * nm_3 + m2) +
                            f_1.numerator * m2,
